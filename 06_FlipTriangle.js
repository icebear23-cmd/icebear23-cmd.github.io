...
function render() {
    ...
    if (moveTag == "up" && ymove < 0.9) {
        ymove += 0.01;
    }
    else if (moveTag == "left" && xmove > -0.9) {
        xmove -= 0.01;   
    }
    else if (moveTag == "right" && xmove < 0.9) {
        xmove += 0.01;
    }
    else if (moveTag == "down" && ymove > -0.9) {
        ymove -= 0.01;
    }
    moveTag = "none";
    shader.setFloat("xmove", xmove);
    shader.setFloat("ymove", ymove);
